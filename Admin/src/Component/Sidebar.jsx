    ...
    return (
        <>
            <div className=" sidebar col-lg-2 " style={{ height: "100vh", backgroundColor: "#f8f9fa" }}>
                <div className=''>
                        <h5 className='d-flex fw-bold justify-content-center ' style={{fontFamily:'times-new-roman', fontStyle:'italic'}}>Alumni</h5>
                </div>
                ...
                <nav class="nav side-nav flex-column " id="nav">
                    ...
                    <NavLink className="nav-link side-link " activeClassName="active" to="/addstudent"><CreateNewFolderRoundedIcon className='mx-2 side-icons' />Add Student</NavLink>
                    <NavLink className="nav-link side-link " activeClassName="active" to="/postevent"><PostAddIcon className='mx-2 side-icons' />Post Event</NavLink>
                    <NavLink className="nav-link side-link " activeClassName="active" to="/event"><CelebrationIcon className='mx-2 side-icons' />Event</NavLink>
