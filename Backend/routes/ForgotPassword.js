...
const User = require('../model/studentmodel/RegisterSchema');
...
let transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
        user: 'bhosalen993', // Replace with your email address
        pass: 'rrznowlmmlsmrpqg', // Replace with your email password
    },
});
